...
//     BTAppContextSwitcher.setReturnURLScheme("com.tegynbadel.app.braintree")
...
//     if url.scheme?.localizedCaseInsensitiveCompare("com.tegynbadel.app.braintree") == .orderedSame {
