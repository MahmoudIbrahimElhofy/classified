...
import 'package:tegy_nbadel/core/vendor/api/common/ps_resource.dart';
import 'package:tegy_nbadel/core/vendor/db/common/ps_data_source_manager.dart';
import 'package:tegy_nbadel/core/vendor/db/user_field_dao.dart';
import 'package:tegy_nbadel/core/vendor/viewobject/common/ps_holder.dart';
import 'package:tegy_nbadel/core/vendor/viewobject/holder/request_path_holder.dart';
import 'package:tegy_nbadel/core/vendor/viewobject/user_filed.dart';
import 'package:sembast/sembast.dart';
import '../api/ps_api_service.dart';
import 'Common/ps_repository.dart';

class UserFieldRepository extends PsRepository {
  UserFieldRepository({required this.psApiService, required this.userFieldDao});
