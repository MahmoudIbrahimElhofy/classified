...
import 'package:tegy_nbadel/ui/vendor_ui/chat/component/detail/conversation_list/widgets/chat_make_appointment_dialog.dart';
...
class CustomChatMakeAppointmentDialog extends StatefulWidget {
  ...
  @override
  _CustomChatMakeAppointmentDialogState createState() =>
      _CustomChatMakeAppointmentDialogState();
}

class _CustomChatMakeAppointmentDialogState
    extends State<CustomChatMakeAppointmentDialog> {
  @override
  Widget build(BuildContext context) {
    return ChatMakeAppointmentDialog(
        itemDetail: widget.itemDetail,
        getChatHistoryProvider: widget.getChatHistoryProvider,
        onMakeOfferTap: widget.onMakeOfferTap);
  }
}
