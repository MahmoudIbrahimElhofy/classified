...
import 'package:tegy_nbadel/core/vendor/api/common/ps_status.dart';
import 'package:tegy_nbadel/core/vendor/constant/ps_constants.dart';
import 'package:tegy_nbadel/core/vendor/db/common/ps_data_source_manager.dart';
import 'package:tegy_nbadel/core/vendor/provider/user/user_feild_provider.dart';
import 'package:tegy_nbadel/core/vendor/repository/user_field_repository.dart';
import 'package:tegy_nbadel/core/vendor/viewobject/custom_field.dart';
import 'package:tegy_nbadel/core/vendor/viewobject/edit_profile_user_relation.dart';
import 'package:tegy_nbadel/core/vendor/viewobject/holder/request_path_holder.dart';
import 'package:tegy_nbadel/core/vendor/viewobject/selected_object.dart';
import 'package:tegy_nbadel/core/vendor/viewobject/selected_value.dart';
import 'package:tegy_nbadel/ui/vendor_ui/common/dialog/warning_dialog_view.dart';
import 'package:tegy_nbadel/ui/vendor_ui/common/ps_app_bar_widget.dart';
import 'package:tegy_nbadel/ui/vendor_ui/common/user_custom_ui/ps_user_cutom_widget.dart';
        ...
        body: MultiProvider(
            ...
            child: Consumer<UserProvider>(builder: (BuildContext context,
              ...
              if (userProvider.user.data != null) {
                if (!userFieldProvider.hasData &&
                    (userFieldProvider.currentStatus ==
                ...
                } else if (!userFieldProvider.hasData) {
                  return const SizedBox();
                } else {
                  updateCustomFieldList(
                      userFieldProvider.userField.data!.customField ??
                          <CustomField>[]);
                }
                      ...
                      ListView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            ...
                            if (customField.coreKeyId != null) {
                              ...
                              // }
                              if (!userFieldProvider.textControllerMap
                                  .containsKey(customField)) {
                                print(
                                    'core and custom field ${customField.coreKeyId}');
                                userFieldProvider.textControllerMap.putIfAbsent(
                                  customField,
                                  () => SelectedObject(
