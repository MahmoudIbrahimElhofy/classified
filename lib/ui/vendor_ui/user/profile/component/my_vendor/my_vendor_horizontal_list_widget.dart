...
import 'package:tegy_nbadel/core/vendor/utils/ps_animation.dart';
...
import 'package:tegy_nbadel/ui/custom_ui/user/profile/component/my_vendor/widget/my_vendor_list_item.dart';
import 'package:tegy_nbadel/ui/vendor_ui/common/ps_list_header_widget.dart';
    ...
    return SliverToBoxAdapter(child: Consumer<VendorUserProvider>(
      builder:
        ...
        return ((provider.currentStatus == PsStatus.BLOCK_LOADING ||
                    provider.hasData) &&
                valueHolder.vendorSetting == PsConst.ONE)
