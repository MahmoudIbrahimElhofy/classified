...
import 'package:tegy_nbadel/core/vendor/api/ps_api_service.dart';
import 'package:tegy_nbadel/core/vendor/provider/common/notification_provider.dart';
  ...
  Future<dynamic> callDateFunction(
    ...
    if (await Utils.checkInternetConnectivity()) {
      ...
      if (_psAppInfo.status == PsStatus.SUCCESS) {
        ...
        if (_psAppInfo.data!.vendorSetting != null) {
          await provider.replaceVendorSetting(_psAppInfo.data!.vendorSetting!);
        }
